...
4. **[merge_and_generate_ann.py](https://github.com/fatemehmirzade/p_denovo_foreign/blob/main/Text_mining_pipeline/merge_and_generate_ann.py)** merge the seven outputs per paper and writes the final annotation table.
